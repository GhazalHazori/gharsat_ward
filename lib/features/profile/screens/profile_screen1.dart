...
import 'package:gharsat_ward/features/profile/widgets/delete_account_bottom_sheet_widget.dart';
...
class _ProfileScreen1State extends State<ProfileScreen1> {
  ...
  _updateUserAccount() async {
    ...
    if (1 != 1
      ...
      // mr_edit
      updateUserInfoModel.cityId = _selectedCityId;

      String pass = _passwordController.text;
      debugPrint('updateUserInfoModel.cityId: ${updateUserInfoModel.cityId}');
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ProfileController>(context, listen: false).fetchCities();
    });
  }
        ...
        body: Consumer<AuthController>(builder: (context, authController, _) {
          return Consumer<ProfileController>(builder: (context, profile, _) {
            if (!isFirstTime) {
              ...
              _selectedCityId = profile.userInfoModel!.cityId;
              isFirstTime = true;
            }
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      CustomTextFieldWidget(
                          ...
                          inputType: TextInputType.name, readOnly: true,
                      ...
                      CustomTextFieldWidget(
                        ...
                        inputType: TextInputType.emailAddress, readOnly: true,
                      ...
                      CustomTextFieldWidget(
                        ...
                        inputType: TextInputType.phone, readOnly: true,
                      ...
                      profile.isLoadingCity
                          ...
                          : DropdownButtonFormField<String>(
                              value: profile.cities.isNotEmpty
                                  ? _selectedCityId
                                  : null,
                      ...
                      CustomTextFieldWidget(
                          ...
                          focusNode: _confirmPasswordFocus,onTap: (){},
