...
import 'package:gharsat_ward/features/chat/domain/models/media_file_model.dart';
...
import 'package:gharsat_ward/features/chat/domain/models/chat_model.dart';
...
class ChatController extends ChangeNotifier {
  ...
  void downloadFile(
    ...
    if (kDebugMode) {
      debugPrint('-----task-----${task != null} || $openFileUrl');
    }
