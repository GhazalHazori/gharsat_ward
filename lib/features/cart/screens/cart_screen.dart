...
import 'package:gharsat_ward/features/cart/widgets/cart_page_shimmer_widget.dart';
import 'package:gharsat_ward/features/cart/widgets/cart_widget.dart';
import 'package:gharsat_ward/features/checkout/screens/checkout_screen.dart';
import 'package:gharsat_ward/features/shipping/widgets/shipping_method_bottom_sheet_widget.dart';
        ...
        return Consumer<CartController>(builder: (context, cart, child) {
          ...
          for (int i = 0; i < cart.cartList.length; i++) {
            if (cart.cartList[i].isChecked!) {
              ...
              if (kDebugMode) {
                debugPrint('====TaxModel == ${cart.cartList[i].taxModel}');
              }
