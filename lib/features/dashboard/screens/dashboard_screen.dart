...
import 'package:gharsat_ward/features/category_home/category_home_screen.dart';
import 'package:gharsat_ward/features/chat/controllers/chat_controller.dart';
import 'package:gharsat_ward/features/dashboard/models/navigation_model.dart';
import 'package:gharsat_ward/features/dashboard/widgets/dashboard_menu_widget.dart';
...
import 'package:gharsat_ward/features/dashboard/widgets/app_exit_card_widget.dart';
import 'package:gharsat_ward/utill/images.dart';
import 'package:gharsat_ward/features/home/screens/aster_theme_home_screen.dart';
import 'package:gharsat_ward/features/home/screens/fashion_theme_home_screen.dart';
import 'package:gharsat_ward/features/home/screens/home_screens.dart';
import 'package:gharsat_ward/features/more/screens/more_screen_view.dart';
import 'package:gharsat_ward/features/order/screens/order_screen.dart';
import 'package:provider/provider.dart';

import '../../../screens/catalog/views/catalog_view.dart';
...
class DashBoardScreenState extends State<DashBoardScreen> {
  ...
  void initState() {
    ...
    _screens = [
      ...
      NavigationModel(
        name: 'Catalog',
        icon: Images.catalogIcon,
        screen: const CategoryScreenHome(),
      ),
      NavigationModel(
          name: 'cart',
      ...
      NavigationModel(
          name: 'Deals',
          icon: Images.deal,
          screen: DiscountedProductListWidget(
            isHomePage: false,
          )),
      NavigationModel(
            ...
            bottomNavigationBar: SafeArea(
              child: Container(
                height: MediaQuery.of(context).size.height *
                    0.08, // نسبة مئوية من ارتفاع الشاشة
