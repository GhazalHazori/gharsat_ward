...
import 'package:gharsat_ward/common/basewidget/custom_directionality_widget.dart';
import 'package:gharsat_ward/common/basewidget/not_logged_in_bottom_sheet_widget.dart';
...
import 'package:gharsat_ward/features/product_details/widgets/color_selection_widget.dart';
...
import 'package:gharsat_ward/features/product_details/widgets/shipping_method_dialog.dart';
...
import 'package:gharsat_ward/helper/product_helper.dart';
...
class CartBottomSheetWidget extends StatefulWidget {
  ...
  const CartBottomSheetWidget(
      {super.key, required this.product, this.callback, this.selectedQuantity});
...
void initState() {
  ...
  if (widget.product != null) {
    int minQty = widget.product!.minimumOrderQty ?? 0;
    _minQuantity = minQty > 0 ? minQty : 100;
    _defaultMultiplier = widget.product!.multiplyQty ?? 100;
            ...
            builder: (ctx, details, child) {
              ...
              CartModelBody cart = CartModelBody(
                  ...
                  color: (widget.product!.colors != null &&
                      ...
                      : '',
                  variation: variation,
                  quantity: _quantity * _minQuantity,
...
void _buyNow(
  ...
  if (response!.data['status'] == 1) {
    ...
    // Directly use the product's shipping method
     CartModel cart = CartModel.fromJson(response.data['cart']);
    double shippingCost = widget.product!.shippingCost!;
    _navigateToCheckoutScreen(context, cart, shippingCost);
  }
}
