...
import 'package:gharsat_ward/features/home/shimmers/recommended_product_shimmer.dart';
        ...
        children: [
          Consumer<ProductController>(
            builder: (context, recommended, child) {
              print('RecommendedProductWidget - Product: ${recommended.recommendedProduct?.name}');
              print('RecommendedProductWidget - Is null: ${recommended.recommendedProduct == null}');
