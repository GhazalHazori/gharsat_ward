import 'package:gharsat_ward/localization/models/language_model.dart';
...
class AppConstants {
  ...
  static const String baseUrl = 'https://gharsat.com/warehouses';
  ...
  // mr_edit
  static const String citiesUri = '/api/v1/cities';
  ...
  static const String genertInvoiceId =
      '/api/v1/pre-invoice/generate';
  // sharePreference
  ...
  static const String choosenCity = 'choosen_city';
