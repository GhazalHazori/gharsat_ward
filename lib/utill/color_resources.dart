...
// mr_edit
  static Color getColombiaOrange(BuildContext context) {
    return Provider.of<ThemeController>(context).darkTheme
        ? const Color(0xFFB37744)
        : const Color(0xFFD99F5F);
  }

// mr_edit
  static Color getLightOrange(BuildContext context) {
    return Provider.of<ThemeController>(context).darkTheme
        ? const Color(0xFFE6BB94)
  ...
  static const Map<int, Color> colorMap = {
    50: Color(0x10D99F5F),
    100: Color(0x20D99F5F),
    200: Color(0x30D99F5F),
    300: Color(0x40D99F5F),
    400: Color(0x50D99F5F),
    500: Color(0x60D99F5F),
    600: Color(0x70D99F5F),
    700: Color(0x80D99F5F),
    800: Color(0x90D99F5F),
    900: Color(0xFFD99F5F),
  };
  // mr_edit
