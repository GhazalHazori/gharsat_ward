...
import 'package:gharsat_ward/data/datasource/remote/dio/logging_interceptor.dart';
...
class DioClient {
  ...
  DioClient(
    ...
    choosenCity = sharedPreferences.getInt(AppConstants.choosenCity);
  ...
  // ... rest of your Dio methods (get, post, put, delete) remain the same ...
  Future<Response> get(
    String uri, {
